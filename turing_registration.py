...
# initialize class
# data = QScore(
#     base_folder = Path('/home/sagemaker-user/user-default-efs/QScore/q_score'),
#     output_path=Path('/home/sagemaker-user/user-default-efs/monk/BIO-20018-01_vc57909_20250417/turing_test'),
#     original_nifti = Path('/home/sagemaker-user/user-default-efs/monk/BIO-20018-01_vc57909_20250417/resave/QTASK_motor_nobio_16bit_maton_20250417134348_13.nii')
#     )
# data.get_q_score()
paths = [
    '/home/sagemaker-user/user-default-efs/monk/BIO-20018-01_vc57909_20250417/fsf_test/QTASK_objnam_withbio_16bit_maton_20250417134348_29/real_new.fsf',]
    #'/home/sagemaker-user/user-default-efs/monk/BIO-20018-01_vc57909_20250417/fsf_test/QTASK_motor_withbio_16bit_maton_20250417134348_17/real_new.fsf']
# for f in paths:
#     feat = fsl.FEAT()
#     feat.inputs.fsf_file = f
#     os.chdir(os.path.dirname(f)) # has to be in current working directory outside of docker run
#     feat.run()

data = QScore(
    base_folder = Path('/home/sagemaker-user/user-default-efs/QScore/q_score'),
    output_path=Path('/home/sagemaker-user/user-default-efs/monk/BIO-20018-01_vc57909_20250417/fsf_test/QTASK_objnam_withbio_16bit_maton_20250417134348_29/'),
    original_nifti = Path('/home/sagemaker-user/user-default-efs/monk/BIO-20018-01_vc57909_20250417/resave/QTASK_objnam_withbio_16bit_maton_20250417134348_29.nii')
    )
